...
| [Identity Threat Protection Scorecard](./Frameworks/Identity-Threat-Protection-Scorecard/) | Preview | itps-v0.1.0-preview (2026-08-12) | 4-dimension scorecard (Prevention, Detection, Governance, Ownership); read-only collector automates Prevention and Detection's health-issue signal via Microsoft Graph, Coverage-and-maturity composite score and Ownership remain manual; 3 scenario examples plus a sample tenant report |
