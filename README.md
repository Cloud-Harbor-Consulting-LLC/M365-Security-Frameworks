...
|-----------|-----------|--------|
| [Conditional Access Baseline](./Frameworks/Conditional-Access-Baseline/) | Entra ID, Zero Trust | 🟡 In progress |
| Intune Compliance Baseline | Endpoint Management | ⚪ Planned (Q3 2026) |
| Entra ID Governance Toolkit | Identity Governance | ⚪ Planned (Q4 2026) |
| Defender XDR Detection Rules | SIEM & XDR | ⚪ Planned (Q1 2027) |
