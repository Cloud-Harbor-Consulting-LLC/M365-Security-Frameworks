...
| CC6.6 | Logical access security measures protect against threats from external sources | Conditional Access risk policy coverage — sign-ins blocked or challenged by CA risk policies (CA-SIG003, CA-SIG004, CA-SIG008, CA-SIG009) | Defender XDR CA policy report | [X% of sign-ins covered by CA risk policies; Y high-risk sign-ins blocked in period] | [Met / Not met] |
| CC7.1 | Detection and monitoring procedures identify configuration changes that introduce new vulnerabilities, and susceptibilities to newly discovered vulnerabilities | Vulnerability scan completion rate and unresolved critical/high vulnerability count | Microsoft Defender Vulnerability Management | [X scans completed in period; Y critical/high vulnerabilities unresolved at period close] | [Met / Not met] |
| CC7.2 | System components are monitored for anomalies indicative of malicious acts; anomalies are analyzed to determine whether they represent security events | Defender XDR coverage and mean time to detect (MTTD) — endpoints, identity, email, cloud apps | Defender XDR coverage report and incident queue | [X% of in-scope assets covered; Y minutes median MTTD for High and Medium incidents] | [Met / Not met] |
